...
import io.bewaremypower.topic.LegacyTopicName;
import io.bewaremypower.topic.TopicName;
...
public class TopicNameBenchmark {
  ...
  private static final String[] topicBases = {
    "test", "tenant/ns/test", "persistent://another-tenant/another-ns/test"
  };
